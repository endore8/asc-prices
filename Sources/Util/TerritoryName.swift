...
enum TerritoryName {
    static func lookup(alpha3: String) -> String? {
        guard let alpha2 = alpha3ToAlpha2[alpha3] else { return nil }
        return Locale(identifier: "en_US").localizedString(forRegionCode: alpha2)
    }
    ...
    static let alpha3ToAlpha2: [String: String] = [
        ...
        "CMR": "CM", "CAN": "CA", "CPV": "CV", "CYM": "KY", "TCD": "TD",
